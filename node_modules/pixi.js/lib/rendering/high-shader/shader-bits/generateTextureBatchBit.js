    ...
    textureBatchBitGpuCache[maxTextures] = {
      ...
      fragment: {
        header: `
                ...
                ${generateBindingSrc(maxRecommendedTextures.getMaxTexturesPerBatch())}
            `,
        main: `
                var uvDx = dpdx(vUV);
                var uvDy = dpdy(vUV);
    
                ${generateSampleSrc(maxRecommendedTextures.getMaxTexturesPerBatch())}
            `
      }
    };
  }
    ...
    textureBatchBitGlCache[maxTextures] = {
      ...
      fragment: {
        ...
        main: `
                ...
                ${generateSampleGlSrc(maxRecommendedTextures.getMaxTexturesPerBatch())}
            `
      }
    };
  }
